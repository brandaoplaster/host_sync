defmodule HostSync.EntityManager do
  @moduledoc """
  HostSync public Entity Manager
  """

  alias Ecto.Changeset
  alias HostSync.EntityManager
  alias HostSync.Repo
  ...
  @optional_callbacks all: 1, one: 1, delete: 1, undelete: 1, preload: 3, transaction: 1

  defmacro __using__([schema: schema] = _opts) do
    quote do
      @behaviour EntityManager
      ...
      schema_name =
        unquote(schema)
        |> Atom.to_string()
        |> String.replace_prefix("Elixir.HostSync.", "")
